...
class Timeline extends React.Component {
  ...
  render () {
    ...
    return (
      <div>
        <Navigation isAdmin={currentUser.admin} backgroundImg={currentUser.fav} user={currentUser.username}tour={TimelineTour} filterFavourites={(category) => {this.handleFilterFavourite(category)}}/>
